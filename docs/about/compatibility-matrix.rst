...
|                           |                           |                         |                         | MI300X,                                       | taichi-internal/en/docs-25.11/install/       |
|                           |                           |                         |                         | MI250X,                                       | taichi-install.html>`__                      |
|                           |                           |                         |                         | MI210                                         |                                              |
+                           +---------------------------+-------------------------+-------------------------+-----------------------------------------------+----------------------------------------------+
|                           | 24.04,                    | 7.0.0,                  | 3.12                    | MI300X                                        | `GSplat v1.5.3                               |
|                           | 22.04                     | 6.4.3                   | 3.10                    |                                               | <https://rocm.docs.amd.com/projects/         |
|                           |                           |                         |                         |                                               | gsplat-internal/en/docs-25.11/install/       |
