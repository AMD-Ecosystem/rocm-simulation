...
+===========================+===========================+=========================+=========================+===============================================+==============================================+
| 25.11                     | 22.04                     | 6.4.3                   | 3.10                    | MI300X                                        | `Taichi v1.8.0b2                             |
|                           | 24.04                     | 7.0.0                   | 3.12                    |                                               | <https://rocm.docs.amd.com/projects/         |
|                           |                           |                         |                         |                                               | taichi-internal/en/docs-25.11/install/       |
|                           |                           |                         |                         |                                               | taichi-install.html>`__                      |
+---------------------------+---------------------------+-------------------------+-------------------------+-----------------------------------------------+----------------------------------------------+
|                           | 24.04                     | 7.0.0                   | 3.12.3                  | MI355X                                        | `GSplat v1.5.3                               |
|                           |                           |                         |                         | MI325X                                        | <https://rocm.docs.amd.com/projects/         |
|                           |                           |                         |                         | MI300X                                        | gsplat-internal/en/docs-25.11/install/       |
...
|                           |                           |                         |                         |                                               | taichi-install.html>`__                      |
+---------------------------+---------------------------+-------------------------+-------------------------+-----------------------------------------------+----------------------------------------------+
|                           | 24.04                     | 6.4.3                   | 3.12                    | MI300X                                        | `GSplat v1.5.3                               |
|                           |                           |                         |                         |                                               | <https://rocm.docs.amd.com/projects/         |
|                           |                           |                         |                         |                                               | gsplat-internal/en/docs-25.10/install/       |
